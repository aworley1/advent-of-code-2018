...
fun main() {
    val frequency2 = getRepeatingFrequency(frequencyChanges, 0, listOf())
    println("frequency with recursion is $frequency2")
}

tailrec fun getRepeatingFrequency(listOfInts: List<Int>, frequency: Int, listOfFrequencies: List<Int>): Int {
